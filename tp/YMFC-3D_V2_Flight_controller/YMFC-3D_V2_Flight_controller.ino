...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
float pid_p_gain_roll = 1.3;               //Gain setting for the roll P-controller (1.3)for s500
float pid_i_gain_roll = 0.04;              //Gain setting for the roll I-controller (0.04)for s500
float pid_d_gain_roll = 35;                //Gain setting for the roll D-controller (35)for s500
...
void setup(){
  ...
  for (cal_int = 0; cal_int < 1250 ; cal_int ++){              //Wait 5 seconds before continuing.
    ...
    delayMicroseconds(900);                                   //Wait 1000us.
    PORTD &= B00001111;                                        //Set digital poort 4, 5, 6 and 7 low.
    delayMicroseconds(3100);                                   //Wait 3000us.
  }
  ...
  for (cal_int = 0; cal_int < 2000 ; cal_int ++){              //Take 2000 readings for calibration.
    ...
    delayMicroseconds(900);                                   //Wait 1000us.
    PORTD &= B00001111;                                        //Set digital poort 4, 5, 6 and 7 low.
    delayMicroseconds(3100);                                                  //Wait 3 milliseconds before the next loop.
  }
...
void loop(){
  ...
  gyro_roll_input = (gyro_roll_input * 0.9) + ((gyro_roll / 57.14286) * 0.1);            //Gyro pid input is deg/sec.
  gyro_pitch_input = (gyro_pitch_input * 0.9) + ((gyro_pitch / 57.14286) * 0.1);         //Gyro pid input is deg/sec.
  gyro_yaw_input = (gyro_yaw_input * 0.9) + ((gyro_yaw / 57.14286) * 0.1);               //Gyro pid input is deg/sec.
  ...
  if (start == 2){                                                          //The motors are started.
    ...
    esc_3 = 900;                                                           //If start is not 2 keep a 1000us pulse for ess-3.
